...
//Versão 0.7 De Truesoft, 2012, Maio 22

public class SplashScreen : MonoBehaviour
{
    public int guiDepth = 0;
    public string levelToLoad = ""; //Esta variável deve corresponder a um level (file>build settings)
    public Texture2D splashLogo; // O logo p/ splash
    public float fadeSpeed = 0.3f;
    public float waitTime = 0.5f; // Secundos para esperar após Fadeout 
    public bool waitForInput = false; // Se verdadeiro, uma opção "Pressione qualquer tecla para continuar" aparecer
