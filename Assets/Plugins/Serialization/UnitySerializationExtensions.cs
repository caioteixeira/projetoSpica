...
//[Serializer(typeof(NavMeshAgent))]
public class SerializeNavMeshAgent : SerializerExtensionBase<NavMeshAgent>
{
	public override IEnumerable<object> Save (NavMeshAgent target)
	{
...
public class SerializeMaterialReference : SerializerExtensionBase<Material>
{
	...
	public override object Load (object[] data, object instance)
	{
		return SaveGameManager.GetAsset<Material>((int)data[0]);
	}
}


[Serializer(typeof(Mesh))]
public class SerializeMeshReference : SerializerExtensionBase<Mesh>
{
	public override IEnumerable<object> Save (Mesh target)
	{
		return new object [] { SaveGameManager.GetAssetId(target) };
	}
	...
	public override object Load (object[] data, object instance)
	{
		return SaveGameManager.GetAsset<Mesh>((int)data[0]);
	}
}


[Serializer(typeof(AudioClip))]
public class SerializeAudioClipReference : SerializerExtensionBase<AudioClip>
{
	public override IEnumerable<object> Save (AudioClip target)
	{
		return new object [] { SaveGameManager.GetAssetId(target) };
	}
	...
	public override object Load (object[] data, object instance)
	{
		return SaveGameManager.GetAsset<AudioClip>((int)data[0]);
	}
}


[Serializer(typeof(AnimationClip))]
public class SerializeAnimationClipReference : SerializerExtensionBase<AnimationClip>
{
	public override IEnumerable<object> Save (AnimationClip target)
	{
		return new object [] { SaveGameManager.GetAssetId(target) };
	}
	...
	public override object Load (object[] data, object instance)
	{
		return SaveGameManager.GetAsset<AnimationClip>((int)data[0]);
	}
}
